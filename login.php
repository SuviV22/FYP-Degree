        ...
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="php/login.php" method="post">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center" name="loginbtn">Login</button>
            </div>
          </form>
          <p class="mt-20">New in this site?<a href="" data-toggle="modal" data-target="#product-modal" style="color: #E74C3C;"> Create New Account</a></p>
          <a href="forget-password.php" style="color: #E74C3C;">Forgot password?</a>
        </div>
      </div>
    </div>
  </div>
