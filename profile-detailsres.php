...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Sacré Bleu | Restaurant Profile</title>
...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">Restaurant Profile</h1>
					<ol class="breadcrumb">
          ...
          <div class="media" style="margin-left:25%;">
            ...
            <div class="media-body">
              <ul class="user-profile-list">
				...
				?>
                <li><span>Restaurant Name:<a href="shop-sidebarres.php"></span><?php echo $row["userName"]; ?></a></li>
							...
							<div class="row">
								...
								<form class="text-left clearfix" action="php/editprofile.php" method="post">
									<div class="form-group">									  
									  <h5>Restaurant Name:<label style="margin-left:4.9%;"></label><input style="width:80%;" type="text" class="form-control" name="name" value="<?php echo $row["userName"]; ?>" required></h5>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									  <h5>Phone No.:<label style="margin-left:11.3%;"></label><input style="width:80%;" type="tel" class="form-control" name="phone" value="<?php echo $row["userPhone"]; ?>" required></h5>
									</div>
									<div class="form-group">
