...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>Sacré Bleu | Reset Password</title>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="php/resetpassword.php" method="post">
            <p>Please enter your new password.</p>
            <div class="form-group">
              <input type="password" class="form-control" name="newpass" id="password" placeholder="Password">
            </div>
			<div class="form-group">
              <input type="password" class="form-control" name="newpassc" id="cpassword" placeholder="Confirm Password">
              <input type="hidden" class="form-control" name="token" id="exampleInputEmail1" value="<?php echo $_GET["token"]; ?>">
            </div>
			<script>
            ...
            <div class="text-center">
              <button type="submit" name="newpwbtn" class="btn btn-main text-center">Reset Password</button>
            </div>
          </form>
        </div>
      </div>
